 ...
 * <p>
 * Style methods are overriden to not rely on Element.getClassName() which does not work with SVG namespace elements (className being a complex object and not a string).
 * <p>
 * 
 * 
