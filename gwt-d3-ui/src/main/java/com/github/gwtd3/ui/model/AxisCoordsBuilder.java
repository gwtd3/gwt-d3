...
/**
 * Converts an arbytrary T object
 * into a pixel distance on an axis,
 * using a delegate {@link PointBuilder} that can convert a object T into
 ...
 * @param <T>
 */
public class AxisCoordsBuilder<T> implements PointViewer<T> {
    ...
    @Override
    public boolean isVisible(final T value) {
        // return true;
        return xModel.isVisible(domainBuilder.x(value));
    }
}
