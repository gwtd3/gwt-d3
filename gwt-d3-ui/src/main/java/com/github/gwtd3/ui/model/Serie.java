...
public class Serie<T> implements SerieChangeHasHandlers<T>, ValueProvider<T> {
	...
	/**
	 * A NamedRange provides a way of logically grouping contiguous values of a
	 * {@link Serie}, in order to apply on these values specific formatting or
	 * behavior.
	 * <p>
	...
	public Serie(final String id, PointBuilder<T> domainBuilder) {
		super();
		this.id = id;
	 ...
	 * <p>
	 * If a range already existed for the given name, the old range is replaced
	 * with the new one.
	 * <p>
	 * The given new range cannot intersect any existing range with another
	 * name.
	 * 
	 * @param name
